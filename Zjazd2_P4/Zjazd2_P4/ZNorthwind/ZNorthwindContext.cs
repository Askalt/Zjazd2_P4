...
namespace Zjazd2_P4.ZNorthwind
{
    public partial class ZNorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Widok> Widok { get; set; }
        public virtual DbSet<Zamówienia> Zamówienia { get; set; }
        public virtual DbSet<ZliczanieZampoDniu> ZliczanieZampoDniu { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-MPTGS57\\SQLEXPRESS;Initial Catalog=ZNorthwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ZliczanieZampoDniu>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ZliczanieZampoDniu");

                entity.Property(e => e.DataZamówienia).HasColumnType("datetime");

                entity.Property(e => e.W).HasColumnType("money");
            });
